...
public class TestCmdLineUtil {
  ...
  public void testCmdLineHelp() throws IOException {
    @SuppressWarnings("rawtypes")
    CmdLineUtil cmd = new CmdLineUtil<>();
    //Nothing should happen as network should be null
    cmd.close();
  ...
  private <ResourcePoolT extends ResourcePool, Builder extends ProtocolBuilder> CmdLineUtil<ResourcePoolT, Builder> ParseAndCloseNetwork(
      String[] mainArgs) {
