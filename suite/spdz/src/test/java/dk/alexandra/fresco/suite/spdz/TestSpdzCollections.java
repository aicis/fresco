...
public class TestSpdzCollections extends AbstractSpdzTest {
  ...
  public void test_close_empty_list() {
    runTest(new CloseListTests.TestCloseEmptyList<>(), PreprocessingStrategy.DUMMY, 2);
  }

  @Test
  public void test_close_list() {
    runTest(new CloseListTests.TestCloseAndOpenList<>(), PreprocessingStrategy.DUMMY, 2);
  }

  @Test
  public void test_close_empty_matrix() {
    runTest(new CloseMatrixTests.TestCloseEmptyMatrix<>(), PreprocessingStrategy.DUMMY, 2);
  }

  @Test
  public void test_close_matrix() {
    runTest(new CloseMatrixTests.TestCloseAndOpenMatrix<>(), PreprocessingStrategy.DUMMY, 2);
  }

  @Test
  public void test_Test_Is_Sorted() {
    runTest(new SearchingTests.TestIsSorted<>(), PreprocessingStrategy.DUMMY, 2);
  }

  @Test
  public void test_permute_empty_rows() {
    runTest(PermuteRowsTests.permuteEmptyRows(), PreprocessingStrategy.DUMMY, 2);
  }

  @Test
  public void test_permute_rows() {
    runTest(PermuteRowsTests.permuteRows(), PreprocessingStrategy.DUMMY, 2);
  }
  ...
  public void test_shuffle_rows_two_parties() {
    runTest(ShuffleRowsTests.shuffleRowsTwoParties(), PreprocessingStrategy.DUMMY, 2);
  }

  @Test
  public void test_shuffle_rows_three_parties() {
    runTest(ShuffleRowsTests.shuffleRowsThreeParties(), PreprocessingStrategy.DUMMY, 3);
  }

  @Test
  public void test_shuffle_rows_empty() {
    runTest(ShuffleRowsTests.shuffleRowsEmpty(), PreprocessingStrategy.DUMMY, 2);
  }
}
