...
public class TestSpdzSInt {
  ...
  public void testEquals(){
    SpdzSInt element = new SpdzSInt(BigInteger.valueOf(25), BigInteger.valueOf(15), BigInteger.valueOf(251));
    ...
    element2 = new SpdzSInt(BigInteger.valueOf(25), BigInteger.valueOf(11), BigInteger.valueOf(251));
    assertFalse(element.equals(element2));
