...
public class SpdzOpenCommitProtocol extends SpdzNativeProtocol<Map<Integer, BigInteger>> {
  ...
  public EvaluationStatus evaluate(int round, SpdzResourcePool spdzResourcePool,
    ...
    if (round == 0 ){// Send your opening to all players
    ...
    } else if (round == 1) {// Receive openings from all parties and check they are valid
      ...
      return EvaluationStatus.HAS_MORE_ROUNDS;
    } else {// If more than three players check if openings where
