...
import dk.alexandra.fresco.tools.bitTriples.mult.MultiplyLeftHelper;
 ...
 * dk.alexandra.fresco.tools.bitTriples.triple.TripleGeneration} and may not be secure if used outside
...
class MultiplyLeft {
   ...
   */
  MultiplyLeft(BitTripleResourcePool resourcePool, Network network, int otherId) {
