...
import dk.alexandra.fresco.tools.bitTriples.mult.MultiplyRightHelper;
 ...
 * {@link dk.alexandra.fresco.tools.bitTriples.triple.TripleGeneration} and may not be secure if used
...
class MultiplyRight {
  ...
  MultiplyRight(BitTripleResourcePool resourcePool, Network network, int otherId) {
