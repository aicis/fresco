package dk.alexandra.fresco.tools.bitTriples.mult;
...
/**
 * A helper class for multiplication-based protocols {@link dk.alexandra.fresco.tools.bitTriples.cope.CopeInputter}
 * and the multiplication sub-protocol used by {@link dk.alexandra.fresco.tools.bitTriples.triple.TripleGeneration}.
...
public class MultiplyRightHelper {
  ...
  public MultiplyRightHelper(BitTripleResourcePool resourcePool, Network network, int otherId) {
