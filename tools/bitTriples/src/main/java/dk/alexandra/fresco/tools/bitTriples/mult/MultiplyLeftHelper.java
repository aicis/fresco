...
/**
 * A helper class for multiplication-based protocols {@link dk.alexandra.fresco.tools.bitTriples.cope.CopeSigner}
...
public class MultiplyLeftHelper {
  ...
  public MultiplyLeftHelper(BitTripleResourcePool resourcePool, Network network, int otherId) {
