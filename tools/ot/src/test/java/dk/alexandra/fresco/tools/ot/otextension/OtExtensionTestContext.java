...
public class OtExtensionTestContext {
   ...
   *
   * @param instanceId The id of the instance we wish to create a resource pool for
   ...
   *
   * @param instanceId The ID which we wish to base the randomness generator on.
