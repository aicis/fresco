...
public class Commitment {
  ...
  public byte[] open(byte[] openingInfo) {
    ...
    System.arraycopy(openingInfo, 0, value, 0, openingInfo.length - DIGEST_LENGTH);
    // The randomness comes at the end
    // TODO[TOR] This should be in use?
    byte[] randomness = new byte[DIGEST_LENGTH];
    System.arraycopy(openingInfo, value.length, randomness, 0, DIGEST_LENGTH);
