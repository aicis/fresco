...
public class TestFieldElement {
  ...
  public void testToBigInteger() {
    assertEquals(new BigInteger("22"), new FieldElement(22, modulus).getValue());
  }
  ...
  public void testConvertToBitVectorAndBack() {
    ...
    FieldElement actual = new FieldElement(bv.toByteArray(),
  ...
  public void testSanityCheckNegativeMod() {
    new FieldElement(111, new BigInteger("-251"));
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSanityCheckBitLengthMismatch() {
    new FieldElement(111, new BigInteger("1111"));
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSanityCheckValueTooLarge() {
    new FieldElement(252, new BigInteger("251"));
  }
