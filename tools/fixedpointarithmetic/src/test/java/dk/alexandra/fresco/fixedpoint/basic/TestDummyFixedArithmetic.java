...
public class TestDummyFixedArithmetic extends AbstractDummyArithmeticTest {
  ...
  public void test_SubKnown2() throws Exception {
    runTest(new BasicFixedPointTests.TestSubKnown2<>(), EvaluationStrategy.SEQUENTIAL, 2);
  }
  ...
  public void test_leq() throws Exception {
    runTest(new MathTests.TestLeq<>(), EvaluationStrategy.SEQUENTIAL, 2);
  }
}
