# -*- coding: utf-8 -*-
#
# FRESCO documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'fresco', u'FRESCO Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'FRESCO', u'FRESCO Documentation',
   author, 'FRESCO', 'One line description of project.',
   'Miscellaneous'),
]
