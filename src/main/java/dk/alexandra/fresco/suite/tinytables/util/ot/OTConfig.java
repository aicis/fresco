...
public class OTConfig {
	...
	/*
	 * Note that SCAPI needs to be installed. Actually the scapi command is just
	 * a script which adds Apache Commons, Scapi and BouncyCastle to the
	 * classpath, so we should be able to do this with a 'java' command instead.
	 */
