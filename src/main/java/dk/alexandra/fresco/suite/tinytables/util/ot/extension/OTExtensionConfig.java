...
public class OTExtensionConfig {
	...
	public static final String OT_RECEIVER = "dk/alexandra/fresco/suite/tinytables/util/ot/scapi/OTExtensionReceiverApplication";
	
	public static final String OT_SENDER = "dk/alexandra/fresco/suite/tinytables/util/ot/scapi/OTExtensionSenderApplication";
