...
public interface AdvancedFixedNumeric extends ComputationDirectory {
   ...
   */
  static AdvancedFixedNumeric using(ProtocolBuilderNumeric builder) {
   ...
   */
  DRes<SFixed> innerProduct(List<DRes<SFixed>> a, List<DRes<SFixed>> b);
   ...
   * @return A deferred result computing computing the inner product of the two lists
   */
  DRes<SFixed> innerProductWithPublicPart(List<BigDecimal> a, List<DRes<SFixed>> b);
   ...
   */
  DRes<SFixed> sqrt(DRes<SFixed> x);
   ...
   */
  DRes<Pair<DRes<SFixed>, DRes<SInt>>> normalize(DRes<SFixed> x);
   ...
   */
  DRes<SFixed> reciprocal(DRes<SFixed> x);
   ...
   */
  DRes<SFixed> twoPower(DRes<SInt> x);
   ...
   */
  DRes<SFixed> polynomialEvalutation(DRes<SFixed> input, double... polynomial);
   ...
   * @return
   */
  DRes<SFixed> condSelect(DRes<SInt> condition, DRes<SFixed> first, DRes<SFixed> second);
