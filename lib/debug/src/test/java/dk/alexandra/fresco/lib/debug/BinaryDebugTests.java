...
import dk.alexandra.fresco.lib.debug.binary.BinaryDebug;
      ...
      return new TestThread<ResourcePoolT, ProtocolBuilderBinary>() {
        ...
        public void test() throws Exception {
          ...
          Application<Void, ProtocolBuilderBinary> app = producer -> producer.seq(seq -> {
            ...
            BinaryDebug debug = new DefaultBinaryDebug(seq);
            debug.openAndPrint("test", inputs, stream);
            debug.marker("test", stream);
            return null;
          });
