      ...
      return new TestThread<ResourcePoolT, ProtocolBuilderNumeric>() {
        ...
        public void test() throws Exception {
          Application<Void, ProtocolBuilderNumeric> app = producer -> producer.seq(seq -> {
            ...
            Debug debug = new DefaultDebug(seq);
            debug.openAndPrint("testNumber", inputs.get(0), stream);
            debug.openAndPrint("testVector", inputs, stream);
            ...
            debug.openAndPrint("testMatrix", matrix, stream);
            return null;
          });
