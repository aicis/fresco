...
public class ZeroTestBruteforce implements Computation<SInt, ProtocolBuilderNumeric> {
  ...
  public DRes<SInt> buildComputation(ProtocolBuilderNumeric builder) {
    return builder.seq((seq) ->
      ...
      BigInteger[] maskedPowers = new MiscBigIntegerGenerators(seq.getBasicNumericContext().getModulus()).getExpFromOInt(maskedO, maxLength);
      ...
      BigInteger[] polynomialCoefficients = new MiscBigIntegerGenerators(seq.getBasicNumericContext().getModulus())
          .getPoly(maxLength);
