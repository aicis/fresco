...
public interface AdvancedBinary extends ComputationDirectory {
   ...
   */
  DRes<SBool> condSelect(DRes<SBool> condition, DRes<SBool> left, DRes<SBool> right);
   ...
   */
  DRes<Pair<SBool, SBool>> oneBitHalfAdder(DRes<SBool> left, DRes<SBool> right);
   ...
   */
  DRes<Pair<SBool, SBool>> oneBitFullAdder(DRes<SBool> left, DRes<SBool> right, DRes<SBool> carry);
   ...
   */
  DRes<List<DRes<SBool>>> fullAdder(List<DRes<SBool>> lefts, List<DRes<SBool>> rights,
      DRes<SBool> inCarry);
   ...
   */
  DRes<List<DRes<SBool>>> binaryMult(List<DRes<SBool>> lefts, List<DRes<SBool>> rights);
   ...
   *         incrementation.
   */
  DRes<List<DRes<SBool>>> bitIncrement(List<DRes<SBool>> large, DRes<SBool> increment);
