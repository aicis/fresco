...
public class BinaryComparisonLoggingDecorator implements PerformanceLogger, BinaryComparison {

  public static final String BINARY_COMPARISON_EQ = "EQ_COUNT";
  public static final String BINARY_COMPARISON_GT = "GT_COUNT";

  private BinaryComparison delegate;
  private long gtCount;
  private long eqCount;
  
  public BinaryComparisonLoggingDecorator(BinaryComparison delegate) {
