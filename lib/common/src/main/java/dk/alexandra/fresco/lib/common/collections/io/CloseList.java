...
public class CloseList implements ComputationParallel<List<DRes<SInt>>, ProtocolBuilderNumeric> {
  ...
  /**
   * See {@link dk.alexandra.fresco.lib.common.collections.Collections#closeList(List, int)
   * closeList}.
   */
  ...
  /**
   * See {@link dk.alexandra.fresco.lib.common.collections.Collections#closeList(int, int)
   * closeList}.
   */
