...
public class KeyedCompareAndSwap implements
   ...
   * the largest key.
   * 
   * @param leftKeyAndValue leftKey: the key of the left pair, leftValue: the value of the left pair
   * @param rightKeyAndValue rightKey: the key of the right pair, rightValue: the value of the right pair
   */
