...
public class CloseMatrix
  ...
  /**
   * See {@link dk.alexandra.fresco.lib.common.collections.Collections#closeMatrix(Matrix, int)
   * closeMatrix}.
   */
  ...
  /**
   * See {@link dk.alexandra.fresco.lib.common.collections.Collections#closeMatrix(int, int, int)
   * closeMatrix}.
   */
