...
public class TestResourcePoolImpl {
  ...
  public void testResourcePoolImpl() throws NoSuchAlgorithmException {
    ResourcePoolImpl rp = new ResourcePoolImpl(0, 1, new HmacDeterministicRandomBitGeneratorImpl());
    assertThat(rp.getMyId(), is(0));
    assertThat(rp.getNoOfParties(), is(1));
    assertThat(rp.getRandomGenerator(), instanceOf(HmacDeterministicRandomBitGeneratorImpl.class));
  }
