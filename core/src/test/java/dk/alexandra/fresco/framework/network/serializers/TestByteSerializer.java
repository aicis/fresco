...
public class TestByteSerializer {
  ...
  public void testDeserializeList() {
    ModulusBigInteger modulus = new ModulusBigInteger(1234);
    ...
    expected.add(new FieldElementBigInteger(257, modulus));
    expected.add(new FieldElementBigInteger(514, modulus));
    expected.add(new FieldElementBigInteger(771, modulus));
