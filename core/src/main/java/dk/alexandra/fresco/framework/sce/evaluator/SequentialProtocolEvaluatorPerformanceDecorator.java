...
public class SequentialProtocolEvaluatorPerformanceDecorator<ResourcePoolT extends ResourcePool, Builder extends ProtocolBuilder>
    extends SequentialEvaluator<ResourcePoolT, Builder> {

  private PerformanceLogger pl;

  public SequentialProtocolEvaluatorPerformanceDecorator(PerformanceLogger pl) {
    super();
    this.pl = pl;
  }
