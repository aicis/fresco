...
import dk.alexandra.fresco.lib.collections.sort.IntegerKeyedCompareAndSwap;
...
public class DefaultAdvancedNumeric implements AdvancedNumeric {
  ...
  public DRes<List<Pair<DRes<SInt>, List<DRes<SInt>>>>> keyedCompareAndSwap(
    ...
    return builder.seq(new IntegerKeyedCompareAndSwap(leftKeyAndValue, rightKeyAndValue));
  }
}
