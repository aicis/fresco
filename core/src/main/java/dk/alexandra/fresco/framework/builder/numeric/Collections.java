...
public interface Collections extends ComputationDirectory {
  ...
  // Batched arithmetic operations

  /**
   * Computes pairwise product of two input lists.
   */
  DRes<List<DRes<SInt>>> batchMultiply(DRes<List<DRes<SInt>>> left, DRes<List<DRes<SInt>>> right);
